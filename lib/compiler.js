...
Compiler.prototype = {
    ...
    visitTag: function(tag){
        ...
        var checkSelfClosing = true;
        if (this.options && typeof this.options.selfclosetags === 'boolean')
          checkSelfClosing = this.options.selfclosetags;
        
        if (checkSelfClosing && ~selfClosing.indexOf(name)) {
            this.buffer('<' + name);
