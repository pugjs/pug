...
Compiler.prototype = {
  ...
  visitTag: function(tag){
    ...
    if ((~selfClosing.indexOf(name) || tag.selfClosing) && !this.xml) {
      ...
      if (!~[
        'html',
        'body', //firstChild不能是空白字符/注释/script/style，建议用base作为分隔
        'head',
        'li',
        'dt','dd',
        ...
        //,'p','tbody','colgroup' //此3个标签受限于一些规则：<a href="http://moonless.net/demo/optional-tags/" target="_blank">http://moonless.net/demo/optional-tags/</a>
      ].indexOf(tag.name)){
        this.buffer('</');
        bufferName();
        this.buffer('>');
