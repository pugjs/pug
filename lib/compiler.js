...
Compiler.prototype = {
  ...
  buffer: function (str, interpolate) {
    ...
    if (this.lastBufferedIdx == this.buf.length) {
      ...
      this.buf[this.lastBufferedIdx - 1] = 'html += ' + this.bufferStartChar + this.lastBuffered + '";'
    } else {
      this.buf.push('html += "' + str + '";');
      this.lastBufferedType = 'text';
  ...
  prettyIndent: function(offset, newline){
    ...
    if (this.parentIndents)
      this.buf.push('html += jade_indent.join("");');
  },
