 ...
 *   - `helpers`  Include helpers as `inline` or get from `global` Jade export, defaults to `global` 
 *
 * @param {String} str
 ...
 *   - `compileDebug`   Include/exclude debug helpers such as rethrow, defaults to `true`
 *
