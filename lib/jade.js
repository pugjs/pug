...
exports.compile = function(str, options){
  ...
  if (options.compileDebug !== false) {
    ...
    source = parse(str, options);
  }

  if (options.client) return new Function('locals', source)
  fn = new Function('locals, jade', source)
  var template = function(locals){ return fn(locals, Object.create(runtime)) }
  template.toString = function() {return 'function (locals, jade){' + source + '}';};
  return template;
};
