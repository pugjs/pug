...
Parser.prototype = {
  ...
  parseExtends: function(){
    ...
    if (!path.indexOf('/')) {
      if (!(dir = this.options.rootpath))
        throw new Error( 'the "rootpath" option is required to extend a file relative to the root path' );
    }
    else {
  ...
  parseInclude: function(){
    ...
    if ( !path.indexOf('/') ) {
      if (!(dir = this.options.rootpath))
        throw new Error( 'the "rootpath" option is required to use includes relative to the root path' );
    }
    else {
      dir = dirname(this.filename);
    }
